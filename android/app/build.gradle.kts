...
android {
    namespace = "com.khulladigitallibrary.app"
    ...
    defaultConfig {
        ...
        applicationId = "com.khulladigitallibrary.app"
    ...
    buildTypes {
        release {
            // Play refuses a debug-signed upload outright, so fall back to it
            // only when no keystore is configured (sideload builds, local dev).
